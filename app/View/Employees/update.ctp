...
<?php echo $this->Form->create('Employee', [
    'id' => 'EmployeesForm',
    'url' => ['controller' => 'employees', 'action' => 'update', $employee['Employee']['id']],
    'type' => 'file',
...
<div class="line-inputs">
    ...
    <div class="upload-image">
        ...
        if (!empty($employee['Employee']['image_url'])) {
            $preview = '' . $employee['Employee']['image_url'];
        }
    ...
    <div class="line-actions-service">
        <select id="services" name="services[]" multiple="multiple" style="width: 100%">
            <?php foreach ($services as $service): ?>
                ...
                $selected = in_array($id, $employeeServices) ? 'selected' : '';
                ?>
                <option value="<?= $id ?>" <?= $selected ?>>
                    <?= h($service['Service']['name']) ?>
                </option>
            <?php endforeach; ?>
        </select>
